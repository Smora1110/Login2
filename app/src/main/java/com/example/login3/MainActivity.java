...
public class MainActivity extends AppCompatActivity {
    ...
    private void irahome() {
        ...
        intent.putExtra("mail", name_editText.getText().toString());
    ...
    private void dameToastdeerror(String error) {
        ...
        switch (error) {
            ...
            case "ERROR_INVALID_EMAIL":
                ...
                name_editText.setError("La dirección de correo electrónico está mal formateada.");
            ...
            case "ERROR_WRONG_PASSWORD":
                ...
                password_editText.setError("la contraseña es incorrecta ");
            ...
            case "ERROR_EMAIL_ALREADY_IN_USE":
                ...
                name_editText.setError("La dirección de correo electrónico ya está siendo utilizada por otra cuenta.");
                name_editText.requestFocus();
                break;
            ...
            case "ERROR_WEAK_PASSWORD":
                ...
                password_editText.setError("La contraseña no es válida, debe tener al menos 6 caracteres");
                password_editText.requestFocus();
                break;
